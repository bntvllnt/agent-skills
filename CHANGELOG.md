...
- ci: add repository validator for skill frontmatter, skill folder/name consistency, local Markdown links, exact generated `llms.txt` / `llms-full.txt` sync, and pinned validator dependencies
